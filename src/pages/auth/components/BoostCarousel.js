...
import image3 from "../../../assets/Rectangle 2.svg";
        ...
        <Paper className={classes.BoxCenterContainer} elevation={0}>
          <Paper className={classes.BoxTopSlid} elevation={0}>
            <Box className={classes.LeftSlid}>
              ...
              <Box className={classes.ContentText}>
                <Typography className={classes.TextTitle}>{t('form_carousel_2_title1')}</Typography>
          ...
          <Paper className={classes.BoxTopSlid2} elevation={0}>
            ...
            <Box className={classes.LeftSlid2}>
              <Box className={classes.ContentText}>
                <Typography className={classes.TextTitle}>{t('form_carousel_2_title2')}</Typography>
                <Typography className={classes.TextInfBig}>
        ...
        <Paper className={classes.BoxCenterContainer} elevation={0}>
          <Paper className={classes.BoxTopSlid} elevation={0}>
            <Box className={classes.LeftSlid}>
              ...
              <Box className={classes.ContentText}>
                <Typography className={classes.TextTitle}>{t('form_carousel_3_title1')}</Typography>
                <Typography className={classes.TextInfBig}>
          ...
          <Paper className={classes.BoxTopSlid2} elevation={0}>
            ...
            <Box className={classes.LeftSlid2}>
              <Box className={classes.ContentText}>
                <Typography className={classes.TextTitle}>{t('form_carousel_3_title2')}</Typography>
                <Typography className={classes.TextInfBig}>
...
// <Paper className={classes.PaperConatinerSilder}>
